    ...
    function renderOrders() {
        ...
        orders.forEach(order => {
            ...
            tr.innerHTML = `
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${order.direccion}</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <a href="orders-admin.html" class="text-blue-600 hover:underline">Ver productos</a>
                </td>
